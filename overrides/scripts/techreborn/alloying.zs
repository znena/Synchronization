...
val Recipes = {
	...
	<techreborn:ingot:1> : [
		...
		[<techreborn:ingot:4> * 6, <ore:dustZinc>],
		[<techreborn:dust:14> * 6, <ore:ingotZinc>],
	...
	<enderio:block_fused_glass> : [
		[<minecraft:glass> * 2, <minecraft:glass> * 2]
	],
	...
	<enderio:item_material:3> : [
		[<enderio:item_material:38> * 3, <enderio:item_material:38> * 3]
	]
} as IIngredient[][][IItemStack];

var Time = {
	<techreborn:ingot:2> : [1200, 900, 900, 600],
	<techreborn:nuggets:5> * 3 : [1800, 1350, 1350, 900],
	<techreborn:ingot:1> : [1200, 1350, 1350, 900],
	<techreborn:ingot:6> : [2400, 1200, 1200, 1200],
	<techreborn:ingot:20> : [400],
	<enderio:item_alloy_nugget:4> * 2 : [1200, 800],
	<contenttweaker:rough_energetic_alloy_ingot> : [1200, 800],
	<enderio:item_alloy_nugget:1> * 2 : [1200],
	<enderio:item_alloy_nugget:7> * 6 : [2400],
...
val Voltage = {
	...
	<enderio:item_alloy_nugget:7> * 6 : [8],
