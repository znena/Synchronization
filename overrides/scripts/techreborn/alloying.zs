...
val Recipes = {
	...
	<enderio:block_fused_quartz> : [
		[<minecraft:quartz> * 8, <minecraft:quartz> * 8]
	],
...
var Time = {
	...
	<enderio:item_alloy_nugget:7> * 3 : [2400],
...
val Voltage = {
	...
	<enderio:item_alloy_nugget:7> * 3 : [8],
